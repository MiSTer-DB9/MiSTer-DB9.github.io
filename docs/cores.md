...
Every core supports DB9MD / DB15 and the direct SNAC8 cable path, plus the key-gated **Saturn** and **PSX** UserIO Joystick adapters (e.g. `sys/joydb9saturn.v`), unlocked at runtime by `db9pro.key`.
